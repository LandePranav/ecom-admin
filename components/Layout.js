...
export default function Layout({children}) {
  ...
  if(!session){
    return(
      <div className="w-screen h-screen bg-gray-300 flex items-center">
  ...
  return (
    <div className="bg-gray-300 min-w-screen min-h-screen">
      <div className="flex items-center px-4 pt-2 md:hidden">
        ...
        <Link href={"/"} className="flex gap-2 p-2 pl-4 flex-grow justify-center pr-8 uppercase">
