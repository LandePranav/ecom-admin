  ...
  return (
    <div className="bg-gray-300 min-w-screen h-dvh">
      <div className="flex items-center px-4 pt-2 md:hidden">
        ...
        <Link href={"/"} onClick={()=>{ if(window.location.pathname ==="/"){ setNavVisible(false)}}} className="flex gap-2 p-2 pl-4 flex-grow justify-center pr-8 uppercase">
      ...
      <div className="flex">
        ...
        <div className="bg-white flex-grow my-2 mx-2 p-4 px-8 rounded-lg w-full h-[90vh] md:h-[97vh] overflow-auto transition-all">
          {children}
        </div>
      </div>
    </div>
